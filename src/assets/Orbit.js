 ...
 *--------------------------------------------------------------------------------------------*/
function addNode(identifier, cR, cG, cB, radius) { // Create a shape and append it to the transform associated with the Sun.
...
function addChildNode(cID, pID, cR, cG, cB, radius) { // This function could replace addNode.
...
function addLabel(identifier) { // Create a text label and display it above the identified shape.
 ...
 *-------------------------------------------------*/
function updatePosition() {  // With each tick of the clock, propagate the position and set the translation attribute.
 ...
 *           Button Handlers                    *
 *----------------------------------------------*/
function toggleOrbits() {  // Step through a list of orbits and show or hide them via transparency.
...
function toggleLabels() {  // Step through a list of asteroid labels and show or hide them via transparency.
...
function showValue(newValue) {  // Read a simulation speed setting from a slider control.
...
function startUpdate() {
	...
	addNode("2011SM68", 0.3, 0.3, 0.3, 0.05);         // Add the asteroids.
	addNode("2014EG45", 0.3, 0.3, 0.3, 0.05);

	addNode("2003EE16", 0.3, 0.3, 0.3, 0.05);
	addNode("2012TY52", 0.3, 0.3, 0.3, 0.05);         // Add more asteroids.
	addNode("2009WM1", 0.3, 0.3, 0.3, 0.05);

	addNode("2006SU49", 0.3, 0.3, 0.3, 0.05);
	addNode("1998SC15", 0.3, 0.3, 0.3, 0.05);         // Add several more asteroids.
	addNode("2010MU112", 0.3, 0.3, 0.3, 0.05);
	addNode("2011AG5", 0.3, 0.3, 0.3, 0.05);
	addNode("1994PC1", 0.3, 0.3, 0.3, 0.05);
	addNode("2012SW20", 0.3, 0.3, 0.3, 0.05);
	addNode("2007PV27", 0.3, 0.3, 0.3, 0.05);
	addNode("2007TU24", 0.3, 0.3, 0.3, 0.05);
	addNode("2004XP14", 0.3, 0.3, 0.3, 0.05);
	addNode("2009KK", 0.3, 0.3, 0.3, 0.05);
	addNode("2007JY2", 0.3, 0.3, 0.3, 0.05);
	addNode("2002CU11", 0.3, 0.3, 0.3, 0.05);
	addNode("2000EK26", 0.3, 0.3, 0.3, 0.05);
	addNode("2001VK5", 0.3, 0.3, 0.3, 0.05);
	addNode("2005YU55", 0.3, 0.3, 0.3, 0.05);
	addNode("2008DJ", 0.3, 0.3, 0.3, 0.05);
	addNode("2000QK130", 0.3, 0.3, 0.3, 0.05);
	addNode("1999JU3", 0.3, 0.3, 0.3, 0.05);
	addNode("2011SR5", 0.3, 0.3, 0.3, 0.05);
	addNode("1997XF11", 0.3, 0.3, 0.3, 0.05);
	addNode("2007RU9", 0.3, 0.3, 0.3, 0.05);
	addNode("Apophis", 0.3, 0.3, 0.3, 0.05);

	addNode("2002NT7", 0.3, 0.3, 0.3, 0.05);
	addNode("2013ED28", 0.3, 0.3, 0.3, 0.05);
	addNode("1993VB", 0.3, 0.3, 0.3, 0.05);
	addNode("2002NY40", 0.3, 0.3, 0.3, 0.05);
	addNode("2003CR20", 0.3, 0.3, 0.3, 0.05);
	addNode("2014PW59", 0.3, 0.3, 0.3, 0.05);
	addNode("2012TO139", 0.3, 0.3, 0.3, 0.05);
	addNode("1999JT6", 0.3, 0.3, 0.3, 0.05);
	addNode("2005LW3", 0.3, 0.3, 0.3, 0.05);
	addNode("1997XR2", 0.3, 0.3, 0.3, 0.05);
	addNode("2011BT15", 0.3, 0.3, 0.3, 0.05);
	addNode("2004VC17", 0.3, 0.3, 0.3, 0.05);
	addNode("2002EZ11", 0.3, 0.3, 0.3, 0.05);
	addNode("1993KH", 0.3, 0.3, 0.3, 0.05);
	addNode("2000EH26", 0.3, 0.3, 0.3, 0.05);
	addNode("2000TU28", 0.3, 0.3, 0.3, 0.05);
	addNode("2010SC41", 0.3, 0.3, 0.3, 0.05);
	addNode("1998OX4", 0.3, 0.3, 0.3, 0.05);
	addNode("2011DV", 0.3, 0.3, 0.3, 0.05);
	addNode("2010XC25", 0.3, 0.3, 0.3, 0.05);
	addNode("2004TL10", 0.3, 0.3, 0.3, 0.05);
	addNode("2011UW158", 0.3, 0.3, 0.3, 0.05);
